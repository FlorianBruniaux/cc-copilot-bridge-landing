        ...
        children: [
              ...
              children: [
                {
                  type: 'span',
                  props: {
                    style: { fontSize: '64px', fontWeight: 800, color: '#e6edf3', lineHeight: 1.1, textAlign: 'center' },
                    children: 'Multi-Provider Router',
                  },
                },
                {
                  type: 'span',
                  props: {
                    style: { fontSize: '64px', fontWeight: 800, color: '#f0883e', lineHeight: 1.1 },
                    children: 'for Claude Code CLI',
                  },
                },
              ],
            },
          ...
          // Subtitle
          {
            ...
            props: {
              ...
              children: 'Anthropic, GitHub Copilot, Ollama. Switch with 3 characters.',
            },
          },
          // Stats row (3 items)
          {
                  ...
                  children: [
                    {
                      type: 'span',
                      props: {
                        style: { fontSize: '40px', fontWeight: 800, color: '#f0883e', lineHeight: 1.2 },
                        children: value,
                      },
                    },
                    {
