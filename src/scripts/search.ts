    ...
    .map((entry, i) => {
      return `<li class="search-result-item"
        ...
        <span class="search-result-type">
          <span style="font-size:0.65rem;font-weight:700;padding:0.15rem 0.4rem;border-radius:4px;letter-spacing:0.05em;background:var(--accent);color:#fff;">${escapeHtml(entry.category.toUpperCase())}</span>
        </span>
